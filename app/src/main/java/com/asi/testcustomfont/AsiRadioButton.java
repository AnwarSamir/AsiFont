...
public class AsiRadioButton extends RadioButton {
    /**
     * Default View Constructor.
     *
     * @param context application context.
     */
    public AsiRadioButton(final Context context) {
        super(context);
    }
     ...
     */
    public AsiRadioButton(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
